...
private:
	...
	// (Auswahl aus dem Dropdown der Einnahme-/Ausgabe-Ribbon-Knoepfe).
	void BucheMitVorlage(BOOL bAusgaben, int nVorlagenSlot);
...
#define ID_CMD_VORLAGE_EINNAHME_BASE 41000
//							        bis 41099
